...
const char *g_pszNotiPostInet		= "Для пользования услугами необходимо настроить сеть передачи данных в телефоне и проверить настройки Internet и MMS: Меню - Настройки - SIM-карты и мобильные сети - Точка доступа (APN). Настройки Internet : APN: internet.letai.ru; Тип APN : default; Протокол роуминга APN : IPv4";
const char *g_pszNotiPostMMS		= "Для пользования услугами необходимо настроить сеть передачи данных в телефоне и проверить настройки Internet и MMS: Меню - Настройки - SIM-карты и мобильные сети - Точка доступа (APN). Настройки MMS : MMSC: http://mmsc; Прокси-сервер MMS: mmsc; Порт MMS: 8080; Тип APN: mms";
const char *g_pszNotiPostInetMMS	= "Для пользования услугами необходимо настроить сеть передачи данных в телефоне и проверить настройки Internet и MMS: Меню - Настройки - SIM-карты и мобильные сети - Точка доступа (APN). Настройки Internet : APN: internet.letai.ru; Тип APN : default; Протокол роуминга APN : IPv4. Настройки MMS : MMSC: http://mmsc; Прокси-сервер MMS: mmsc; Порт MMS: 8080; Тип APN: mms";
...
const char *g_pszTextInet			= "Для пользования услугами необходимо настроить сеть передачи данных в телефоне и проверить настройки Internet и MMS: Настройки - Сотовая связь - Сотовая сеть передачи данных. Настройки Internet : APN: internet.letai.ru";
const char *g_pszTextMMS			= "Для пользования услугами необходимо настроить сеть передачи данных в телефоне и проверить настройки Internet и MMS: Настройки - Сотовая связь - Сотовая сеть передачи данных. Настройки MMS : APN: mms; MMSC: http://mmsc; MMS-прокси: mmsc:8080";
